...
(function($) {
	$.fn.fullpage = function(options) {
		...
		if(wAncho > 700){marginTop = 122;}else{ marginTop = 50;}
		...
		if(options.verticalCentered){
			$('.section').addClass('table').wrapInner('<div class="tableCell" style="height:' + (windowsHeight - marginTop) + 'px" />');
		}
		...
		$('.section').each(function(index){
			...
			$(this).css('height', (windowsHeight - marginTop) + 'px');
		...
		*/
		...
		function doneResizing() {
			...
			var windowsHeight = $(window).height()-marginTop;
		...
		function resizeMe(displayHeight, displayWidth) {
			...
			var marginTop = 0;
			var wAncho = $(window).width();
			if(wAncho > 700){marginTop = 78;}else{ marginTop = 50;}
